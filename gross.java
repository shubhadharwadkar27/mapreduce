...
//Partitioner
public static class GrossPartitioner extends Partitioner < Text, Text >
{
   @Override
...
public static class GrossReducer extends
Reducer<Text, Text, NullWritable, Text> {
	...
	public static void main(String[] args) throws Exception {
	    ...
	    job.setJarByClass(gross.class);
	    job.setMapperClass(GrossMap.class);
	    job.setPartitionerClass(GrossPartitioner.class);
